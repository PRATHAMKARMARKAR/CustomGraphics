  ...
  return (
    <>
      <div className="main    " style={{ height: `${height}%` }}  >
        <div
          className="box text-[#FD520F] text-xl flex  justify-center items-center mt-3"
        ...
        >
          ...
          <button className="h-full w-1/2 mb-28 -ml-5">Contact us</button>
          ...
          <button className="h-full  w-1/2 mb-30  -ml-8 ">Home</button>
          ...
          <button className="h-full w-1/2 -ml-5">About us</button>
